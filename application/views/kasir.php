                ...
                <div class="form-body"> 
                  ...
                  <div class="form-group">
                    <label>Nama Pemesan</label>
                      <input type="text" class="form-control" placeholder="Masukan Nama Pemesan" name="nama" required>
                      <i class="form-control-feedback"></i><span class="text-warning" ></span>
                  </div>  
                    
                    <div class="form-group">
                    <label>Refdetail</label>
                      <input type="text" class="form-control" placeholder="Refdetail" name="ref" required>
                      <i class="form-control-feedback"></i><span class="text-warning" ></span>
                  </div>  
                 ...
                 <div class="form-group">
                  <label>Waktu Pemesanan</label>
                      <input type="text" class="form-control" placeholder="Masukan Waktu Pemesanan" name="waktu" required>
                      <i class="form-control-feedback"></i><span class="text-warning" ></span>
                  </div>
                  </div>
                  </div>
...
<script type="text/javascript">
        ...
        $(document).ready(function() {
          table = $('#table').DataTable({  
            "processing": true, 
            "ajax": {
                "url": "<?php echo base_url('kasir/setView'); ?>",
                "type": "POST",
            },
            "columns": [
    ...
    $('.modal-title').text('Input Kasir'); // Set Title to Bootstrap modal title
    }
    ...
    $.ajax({
    url : "<?php echo base_url('kasir/ajax_edit')?>/" + id,
    type: "GET",
    dataType: "JSON",
    ...
    $('[name="nama"]').val(data.nama_pemesan);
    $('[name="ref"]').val(data.refdetail);
    $('[name="meja"]').val(data.meja);
    $('[name="waktu"]').val(data.waktu_pemesanan);
    ...
    if(save_method == 'add') {
    url = "<?php echo base_url('kasir/ajax_add')?>";
    } else {
    url = "<?php echo base_url('kasir/ajax_update')?>";
    }
    ...
    $.ajax({
    url : "<?php echo base_url('kasir/ajax_delete')?>/" +id,
    type: "POST",
    dataType: "JSON",
    success: function(data)
    {
